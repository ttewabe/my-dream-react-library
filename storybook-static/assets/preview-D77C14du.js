import { d as Y } from './index-DrFu-skq.js';
...
var g = 'backgrounds',
    ...
    I = () => {
        ...
        return !!(
            (r =
                T == null
                    ? void 0
                    : T.matchMedia('(prefers-reduced-motion: reduce)')) !=
                null && r.matches
        );
    },
    A = (r) => {
    ...
    U = (r, e, t) => {
        ...
        if (d) d.innerHTML !== e && (d.innerHTML = e);
            ...
            let i = `addon-backgrounds-grid${t ? `-docs-${t}` : ''}`,
                n = $.getElementById(i);
            n
                ? (a = n.parentElement) == null || a.insertBefore(o, n)
                : $.head.appendChild(o);
        }
    },
    ...
    q = (r, e) => {
        ...
        let { globals: t, parameters: d } = e,
            ...
            o = d[g],
            i = h(
                () => (o.disable ? 'transparent' : W(a, o.values, o.default)),
                [o, a]
            ),
