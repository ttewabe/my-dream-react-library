            ...
            (function (n, a) {
                (function (o, i) {
                    ...
                    class u extends Error {
                        constructor(t) {
                            super(
                                `The parsing ended early. The next token was: ${i(t)}`
                            ),
                                (this.token = t),
                    ...
                    function m(e) {
                        return (t) =>
                            t.startsWith(e) ? { type: e, text: e } : null;
                    }
                    function h(e) {
                        let t = 0,
                            r;
                    ...
                    const se = (e) => {
                            ...
                            return t == null
                                ? null
                                : { type: 'StringValue', text: t };
                        },
                        Vt = (e) =>
                            e.length > 0 ? null : { type: 'EOF', text: '' },
                        Dt = (e) => {
                            const t = X(e);
                            return t === null
                                ? null
                    ...
                    class K {
                        static create(t) {
                            ...
                            const s = this.read(t);
                            return (
                                (t = s.text), new K(t, void 0, r.token, s.token)
                            );
                        }
                        constructor(t, r, s, l) {
                            (this.text = ''),
                    ...
                    const z = g({
                        ...
                        Ct = g({
                            ...
                            parsePrefix: (e) => {
                                if (e.consume('null'))
                                    return { type: 'JsdocTypeNull' };
                                if (e.consume('undefined'))
                                    return { type: 'JsdocTypeUndefined' };
                                if (e.consume('*'))
                                    return { type: 'JsdocTypeAny' };
                                if (e.consume('?'))
                                    return { type: 'JsdocTypeUnknown' };
                                throw new Error(
                                    'Unacceptable token: ' +
                                        e.lexer.current.text
                                );
                            },
                        }),
                        Yt = g({
                    ...
                    function Gt({ allowTrailingComma: e }) {
                        return g({
                            ...
                            parseInfix: (t, r) => {
                                ...
                                do
                                    try {
                                        const l = t.parseIntermediateType(
                                            f.PARAMETER_LIST
                                        );
                                        s.push(ie(l));
                                    } catch (l) {
                                        if (e && l instanceof p) break;
                                        throw l;
                                    }
                                while (t.consume(','));
                                if (
                    ...
                    const Wt = g({
                            ...
                            parseInfix: (e, t) => {
                                ...
                                if (!e.consume('>'))
                                    throw new Error(
                                        'Unterminated generic parameter list'
                                    );
                                return {
                    ...
                    function ee({
                        ...
                        return function (l, d, T) {
                            ...
                            const J = l.lexer.current.type,
                                x = l.lexer.next.type;
                            if (
                                !(
                                    (J === '.' && x !== '<') ||
                                    (J === '[' &&
                                        (e || T.type === 'JsdocTypeName')) ||
                                    (t && (J === '~' || J === '#'))
                                )
                            )
                                return null;
                            ...
                            l.consume('.')
                                ? (k = 'property')
                                : l.consume('[')
                                  ? ((k = 'property-brackets'), (re = !0))
                                  : l.consume('~')
                                    ? (k = 'inner')
                                    : (l.consume('#'), (k = 'instance'));
                            const $e = r !== null ? new U(r, l.lexer, l) : l,
                                O = $e.parseIntermediateType(f.NAME_PATH);
                            l.acceptLexerState($e);
                            let B;
                            switch (O.type) {
                                case 'JsdocTypeName':
                                    B = {
                        ...
                        return g({
                            ...
                            parsePrefix: (r) => {
                                ...
                                if (r.consume('StringValue'))
                                    ...
                                    let x = '';
                                    const v = ['Identifier', '@', '/'];
                                    for (; v.some((k) => r.consume(k)); )
                                        (x += d.text), (d = r.lexer.current);
                                    l = {
                                        type: 'JsdocTypeSpecialNamePath',
                                        value: x,
                                        specialType: s,
                                ...
                                const T = new U(e, r.lexer, r),
                                    J = T.parseInfixIntermediateType(l, f.ALL);
                    ...
                    const Re = [
                        ...
                        V = [
                            ...Re,
                            te({ allowedTypes: ['event'], pathGrammar: Re }),
                        ];
                    function ue(e) {
                        let t;
                    ...
                    function ye({
                        ...
                        return g({
                            ...
                            accept: (l, d) =>
                                ...
                                (s && l === 'new' && d === '('),
                            parsePrefix: (l) => {
                                const d = l.consume('new');
                                l.consume('function');
                                const T = l.lexer.current.type === '(';
                                if (!T) {
                                    if (!r)
                                        throw new Error(
                                ...
                                const x = l.parseIntermediateType(f.FUNCTION);
                                if (e === void 0) J.parameters = Qt(x);
                                else {
                                    if (
                                        d &&
                                        x.type === 'JsdocTypeFunction' &&
                                        x.arrow
                                    )
                                        return (J = x), (J.constructor = !0), J;
                                    J.parameters = ue(x);
                                ...
                                if (l.consume(':'))
                                    J.returnType = l.parseType(f.PREFIX);
                                else if (!t)
                                    throw new Error(
                    ...
                    function de({
                        ...
                        return g({
                            ...
                            parsePrefix: (r) => {
                                ...
                                const s = t && r.consume('[');
                                try {
                                    const l = r.parseType(f.PREFIX);
                                    if (s && !r.consume(']'))
                                        throw new Error(
                                            "Unterminated variadic type. Missing ']'"
                                        );
                                    return {
                            ...
                            parseInfix: (e, t) => {
                                ...
                                if (!e.consume(')')) {
                                    ...
                                    if (((r.element = Bt(s)), !e.consume(')')))
                                        throw new Error(
                                            'Symbol does not end after value'
                                        );
                                }
                                return r;
                            },
                            ...
                            parsePrefix: (r) => {
                                ...
                                if (!r.consume('}')) {
                                    ...
                                    for (;;) {
                                        ...
                                        let T = d.parseIntermediateType(
                                            f.OBJECT
                                        );
                                        r.acceptLexerState(d),
                                            T === void 0 &&
                                                t &&
                                                (T = r.parseIntermediateType(
                                                    f.OBJECT
                                                ));
                                        let J = !1;
                                        if (
                                    ...
                                    if (
                                        ((s.meta.separator = l ?? 'comma'),
                                        !r.consume('}'))
                                    )
                                        throw new Error(
                                            "Unterminated record type. Missing '}'"
                                        );
                                }
                                return s;
                            },
                        ...
                        return g({
                            ...
                            parseInfix: (l, d) => {
                                ...
                                s &&
                                    ...
                                    r &&
                                        d.type ===
                                            'JsdocTypeReadonlyProperty' &&
                                        ((x = !0), (d = d.element));
                                const v =
                                    (T = l.baseParser) !== null && T !== void 0
                                        ? T
                                        : l;
                                if (
                                    (v.acceptLexerState(l),
                                    d.type === 'JsdocTypeNumber' ||
                                        d.type === 'JsdocTypeName' ||
                                        d.type === 'JsdocTypeStringValue' ||
                                        ce(d))
                                ) {
                                    if (ce(d) && !e) throw new y(d);
                                    v.consume(':');
                                    let k;
                                    d.type === 'JsdocTypeStringValue' &&
                                        (k = d.meta.quote);
                                    ...
                                    return (
                                        l.acceptLexerState(v),
                                        {
                                            type: 'JsdocTypeObjectField',
                                            key: ce(d) ? d : d.value.toString(),
                                            right: re,
                                            optional: J,
                                            readonly: x,
                                            meta: { quote: k },
                                    ...
                                    if (!t) throw new y(d);
                                    v.consume(':');
                                    const k = v.parseType(f.KEY_VALUE);
                                    return (
                                        l.acceptLexerState(v),
                                        {
                            ...
                            parsePrefix: (e) => {
                                ...
                                return (
                                    e.consume('is'),
                                    {
                                        ...
                                        left: t,
                                        right: w(
                                            e.parseIntermediateType(f.INFIX)
                                        ),
                                    }
                                );
                            },
                        ...
                        return g({
                            ...
                            parsePrefix: (t) => {
                                ...
                                if (
                                    !e &&
                                    r.elements.some(
                                        (l) => l.type === 'JsdocTypeUnknown'
                                    )
                                )
                                    throw new Error(
                                        'Question mark in tuple not allowed'
                                    );
                                return r;
                            },
                        });
                        ...
                        rn = g({
                            ...
                            parsePrefix: (e) => {
                                if ((e.consume('import'), !e.consume('(')))
                                    throw new Error(
                                        'Missing parenthesis after import keyword'
                                    );
                        ...
                        ln = g({
                            ...
                            parsePrefix: (e) => {
                                if (e.baseParser === void 0)
                                    throw new Error(
                                        'Only allowed inside object grammar'
                                    );
                                e.consume('[');
                                const t = e.lexer.current.text;
                            ...
                            JsdocTypeFunction: (e, t) => {
                                if (e.arrow) {
                                    if (e.returnType === void 0)
                                        throw new Error(
                                            'Arrow function needs a return type.'
                                        );
                    ...
                    const Jn = {
                        ...
                        JsdocTypeJsdocObjectField: () => {
                            throw new Error(
                                'Keys may not be typed in jsdoctypeparser.'
                            );
                        },
                        JsdocTypeKeyValue: (e, t) => {
                            if (e.right === void 0)
                        ...
                        JsdocTypeNamePath: (e, t) => {
                            ...
                            if (d.owner.type === 'MODULE') {
                                const T = d.owner;
                                return (
                                    (d.owner = d.owner.value), (T.value = d), T
                                );
                            } else return d;
                        },
                        JsdocTypeUnion: (e, t) =>
                            he('UNION', e.elements.map(t)),
                        JsdocTypeParenthesis: (e, t) => ({
                            type: 'PARENTHESIS',
                            value: t(w(e.element)),
                        }),
...
var Je = Pn(),
    ...
    c = (n, a) => vn(n, 'name', { value: a, configurable: !0 });
const { UnknownArgTypesError: Sn } =
    __STORYBOOK_MODULE_CORE_EVENTS_PREVIEW_ERRORS__;
var xn = c((n) => n.name === 'literal', 'isLiteral'),
    kn = c((n) => n.value.replace(/['|"]/g, ''), 'toEnumOption'),
    On = c((n) => {
        switch (n.type) {
            case 'function':
    ...
    Y = c((n) => {
        ...
        switch ((typeof o < 'u' && (i.raw = o), n.name)) {
            ...
            case 'signature':
                return { ...i, ...On(n) };
            case 'union':
                return (p = n.elements) != null && p.every(xn)
                    ? {
                          ...i,
                          name: 'enum',
                          value: (u = n.elements) == null ? void 0 : u.map(kn),
                      }
                    : {
                          ...i,
                          name: a,
...
c(Me, 'mapValues');
var Ce = /^['"]|['"]$/g,
    In = c((n) => n.replace(Ce, ''), 'trimQuotes'),
    An = c((n) => Ce.test(n), 'includesQuotes'),
    Ye = c((n) => {
        let a = In(n);
                ...
                return (
                    ...
                    p.every((b) => b.name === 'literal')
                        ...
                        : (h = {
                              ...
                              name: a,
                              value:
                                  (y = n.elements) == null ? void 0 : y.map(G),
                          }),
                    h
                );
            case 'intersection':
...
c(ae, 'isDefaultValueBlacklisted');
var Un = c((n) => {
    if (!n) return '';
...
function j(n) {
    ...
    return a == null
        ? ['', n]
        : [n.slice(0, a[0].length), n.slice(a[0].length)];
}
c(j, 'splitSpace');
function ze(n) {
    return n.split(/\n/);
...
function rt({ startLine: n = 0, markers: a = _ } = {}) {
    ...
    return c(function (p) {
        ...
        if (
            ((y.description = u),
            o.push({ number: i, source: p, tokens: y }),
            i++,
            m)
        ) {
            let h = o.slice();
    ...
    return c(function (a) {
        ...
        for (let p of n)
            if (
                ((i = p(i)),
                !(
                    (o = i.problems[i.problems.length - 1]) === null ||
                    o === void 0
                ) && o.critical)
            )
                break;
    ...
    return (o) => {
        ...
        for (let [m, [h, b]] of p.entries())
            (h.type = b),
                ...
                ([h.postType, h.description] = j(
                    h.description.slice(b.length)
                )),
                u.push(h.type);
        return (
            (u[0] = u[0].slice(1)),
...
c(it, 'getJoiner');
var Kn = c((n) => n && n.startsWith('"') && n.endsWith('"'), 'isQuoted');
function ct() {
    let n = c((a, { tokens: o }, i) => (o.type === '' ? a : i), 'typeEnd');
    return (a) => {
...
c(pt, 'compactJoiner');
var $n = c((n, { tokens: a }, o) => (a.type === '' ? n : o), 'lineNo'),
    qn = c(
        ({ tokens: n }) =>
            (n.delimiter === '' ? n.start : n.postDelimiter.slice(1)) +
            n.description,
        'getDescription'
    );
function ut(n, a = _) {
...
c(ht, 'extractJsDocTags');
function gt(n) {
    return n.replace(/[\.-]$/, '');
}
c(gt, 'normaliseParamName');
function Jt(n) {
    ...
    return {
        ...
        getPrettyName: c(() => gt(n.name), 'getPrettyName'),
        getTypeName: c(() => (a ? Se(a) : null), 'getTypeName'),
    };
}
c(Jt, 'extractParam');
function wt(n) {
...
c(wt, 'extractDeprecated');
function be(n, a) {
    let o = n === '' ? a : `${n} ${a}`;
    return Pe(o);
}
c(be, 'joinNameAndDescription');
function Pe(n) {
    let a = n.replace(/^- /g, '').trim();
    return a === '' ? null : a;
}
c(Pe, 'normaliseDescription');
function Nt(n) {
    let a = ve(n.type);
    return a
        ? {
              ...
              getTypeName: c(() => Se(a), 'getTypeName'),
          }
        : null;
}
c(Nt, 'extractReturns');
...
c(Se, 'extractTypeName');
function xe(n) {
    return n.length > 90;
}
c(xe, 'isTooLongForTypeSummary');
function Et(n) {
    return n.length > 50;
}
c(Et, 'isTooLongForDefaultValueSummary');
function E(n, a) {
...
c(bt, 'createDefaultValue');
function ke({ name: n, value: a, elements: o, raw: i }) {
    return a ?? (o != null ? o.map(ke).join(' | ') : (i ?? n));
}
c(ke, 'generateUnionElement');
...
c(tr, 'extractComponentDescription');
