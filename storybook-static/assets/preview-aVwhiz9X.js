    ...
    let r = { ...V, ...t },
        n = function (...c) {
            ...
            if (t.implicit) {
                let y =
                    (g =
                        '__STORYBOOK_PREVIEW__' in p
                            ? p.__STORYBOOK_PREVIEW__
                            : void 0) == null
                        ? void 0
                        : g.storyRenders.find(
                              (d) =>
                ...
                if (y) {
                    let d = !(
                            (O = window == null ? void 0 : window.FEATURES) !=
                                null && O.disallowImplicitActionsInRenderV8
                        ),
...
var T = (e, t) => typeof t[e] > 'u' && !(e in t),
    B = (e) => {
        ...
        return Object.entries(r)
            ...
            .reduce(
                (s, [a, _]) => (
                    T(a, t) && (s[a] = u(a, { implicit: !0, id: n })), s
                ),
                {}
            );
    },
            ...
            : Object.entries(r)
                  ...
                  .reduce(
                      (c, [i, s]) => (
                          T(i, t) &&
                              (c[i] = u(
                                  typeof s.action == 'string' ? s.action : i
                              )),
                          c
                      ),
                      {}
