import { a as hf } from './index-BpYrhlGc.js';
var hu = { exports: {} },
    ve = {},
    yu = { exports: {} },
    gu = {};
                ...
                function on(w, z) {
                    ...
                    try {
                        for (
                            Ln(z), ue = p(ae);
                            ue !== null &&
                            (!(ue.expirationTime > z) || (w && !xt()));

                        ) {
                            var O = ue.callback;
                            if (typeof O == 'function') {
                                (ue.callback = null), (Z = ue.priorityLevel);
...
var ha;
function gf() {
    return ha || ((ha = 1), (yu.exports = yf())), yu.exports;
}
/**
 * @license React
...
` + l[u].replace(' at new ', ' at ');
    ...
    function Du() {
        if (bn) {
            var e = bn,
                n = et;
            if (((et = bn = null), Mu(e), n))
                for (e = 0; e < n.length; e++) Mu(n[e]);
        }
    }
    function Ou(e, n) {
        return e(n);
    ...
    function Vu(e) {
        return (e = Na(e)), e !== null ? Au(e) : null;
    }
    function Au(e) {
    ...
    var Bu = Y.unstable_scheduleCallback,
        ...
        Qu = Y.unstable_UserBlockingPriority,
        gr = Y.unstable_NormalPriority,
        La = Y.unstable_LowPriority,
        Wu = Y.unstable_IdlePriority,
        wr = null,
        He = null;
    function Ma(e) {
    ...
    function Er(e, n) {
        ...
        if (u !== 0) {
            var o = u & ~l;
            o !== 0 ? (r = Dt(o)) : ((i &= u), i !== 0 && (r = Dt(i)));
        } else (u = t & ~l), u !== 0 ? (r = Dt(u)) : i !== 0 && (r = Dt(i));
        if (r === 0) return 0;
        if (
            n !== 0 &&
            n !== r &&
    ...
    function Va(e, n, t, r, l) {
        switch (n) {
            ...
            case 'gotpointercapture':
                return (
                    (i = l.pointerId),
                    It.set(i, jt(It.get(i) || null, e, n, t, r, l)),
                    !0
                );
        }
        return !1;
    ...
    function Vt(e) {
        ...
        for (; 0 < pn.length && ((t = pn[0]), t.blockedOn === null); )
            qu(t), t.blockedOn === null && pn.shift();
    }
    ...
    function Hl(e, n, t, r) {
        if (_r) {
            var l = Ql(e, n, t, r);
            if (l === null) ui(e, n, r, Nr, t), Ju(e, r);
            else if (Va(l, e, n, t, r)) r.stopPropagation();
            else if ((Ju(e, r), n & 4 && -1 < Ua.indexOf(e))) {
                for (; l !== null; ) {
                    var i = Jt(l);
                    if (
                        (i !== null && Yu(i),
                        (i = Ql(e, n, t, r)),
                        i === null && ui(e, n, r, Nr, t),
                        i === l)
                    )
                        break;
                    l = i;
        ...
        Lr = E({}, At, {
            ...
            movementX: function (e) {
                return 'movementX' in e
                    ...
                    : (e !== Bt &&
                          (Bt && e.type === 'mousemove'
                              ? ((Kl = e.screenX - Bt.screenX),
                                (Yl = e.screenY - Bt.screenY))
                              : (Yl = Kl = 0),
                          (Bt = e)),
                      Kl);
            },
    ...
    var tc = E({}, At, {
        ...
        uc = ye(ic),
        oc = E({}, tt, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
        sc = ye(oc),
        ac = E({}, Lr, {
            deltaX: function (e) {
                return 'deltaX' in e
    ...
    var dc = Pe && 'TextEvent' in window && !Ht,
        uo = Pe && (!Zl || (Ht && 8 < Ht && 11 >= Ht)),
        oo = ' ',
        so = !1;
    function ao(e, n) {
        switch (e) {
    ...
    var xc = Pe && 'documentMode' in document && 11 >= document.documentMode,
        lt = null,
        ei = null,
        Kt = null,
        ni = !1;
    ...
    function Dr(e) {
        ...
        var n = it[e],
            t;
        for (t in n) if (n.hasOwnProperty(t) && t in Co) return (ti[e] = n[t]);
        return e;
    }
    ...
    for (var ri = 0; ri < To.length; ri++) {
        var li = To[ri],
            _c = li.toLowerCase(),
            Nc = li[0].toUpperCase() + li.slice(1);
        vn(_c, 'on' + Nc);
    }
    ...
    function Do(e, n, t, r, l) {
        for (var i = n._reactName, u = []; t !== null && t !== r; ) {
            ...
            o.tag === 5 &&
                ...
                ((o = d),
                l
                    ? ((s = Lt(t, i)), s != null && u.unshift(Gt(t, s, o)))
                    : l || ((s = Lt(t, i)), s != null && u.push(Gt(t, s, o)))),
                (t = t.return);
        }
...
`
    ...
    var ci = typeof setTimeout == 'function' ? setTimeout : void 0,
        ...
        Mc =
            typeof queueMicrotask == 'function'
                ...
                : typeof Fo < 'u'
                  ? function (e) {
                        return Fo.resolve(null).then(e).catch(Rc);
                    }
                  : ci;
    function Rc(e) {
        setTimeout(function () {
    ...
    var ot = Math.random().toString(36).slice(2),
        ...
        di = '__reactEvents$' + ot,
        Dc = '__reactListeners$' + ot,
        Oc = '__reactHandles$' + ot;
    function Dn(e) {
        var n = e[Qe];
        if (n) return n;
    ...
    function Uo(e, n, t) {
        ...
        r = r.getChildContext();
        for (var l in r)
            if (!(l in n)) throw Error(p(108, Jn(e) || 'Unknown', l));
        return E({}, t, r);
    }
    function Ar(e) {
        return (
    ...
    function wn() {
        if (!mi && be !== null) {
            ...
            try {
                ...
                throw (be !== null && (be = be.slice(e + 1)), Bu(Il, wn), l);
            } finally {
                (R = n), (mi = !1);
            }
        }
    ...
    function Yo(e) {
            ...
            return x === Le
                ...
                : a !== null &&
                  ...
                  ? ((y = l(a, f.props)),
                    ...
                    (y.return = c),
                    y)
                  : ((y = vl(f.type, f.key, f.props, null, c.mode, y)),
                    (y.ref = qt(c, a, f)),
                    (y.return = c),
                    y);
        }
        function d(c, a, f, y) {
            return a === null ||
                ...
                ? ((a = fu(f, c.mode, y)), (a.return = c), a)
                : ((a = l(a, f.children || [])), (a.return = c), a);
        }
        function v(c, a, f, y, x) {
            return a === null || a.tag !== 7
                ? ((a = Wn(f, c.mode, y, x)), (a.return = c), a)
                : ((a = l(a, f)), (a.return = c), a);
        }
        function h(c, a, f) {
            ...
            if (typeof a == 'object' && a !== null) {
                switch (a.$$typeof) {
                    case on:
                        return (
                            (f = vl(a.type, a.key, a.props, null, c.mode, f)),
                            (f.ref = qt(c, null, a)),
                            (f.return = c),
                            f
                        );
        ...
        function m(c, a, f, y) {
            ...
            if (typeof f == 'object' && f !== null) {
                switch (f.$$typeof) {
                    ...
                    case Se:
                        return (x = f._init), m(c, a, x(f._payload), y);
                }
                if (zt(f) || z(f))
        ...
        function C(c, a, f, y) {
            ...
            for (
                var _ = (x = null), N = a, P = (a = 0), b = null, L = f.next();
                N !== null && !L.done;
                P++, L = f.next()
            ) {
                N.index > P ? ((b = N), (N = null)) : (b = N.sibling);
                ...
                e && N && Pn.alternate === null && n(c, N),
                    (a = i(Pn, a, P)),
                    _ === null ? (x = Pn) : (_.sibling = Pn),
                    (_ = Pn),
                    (N = b);
            }
            if (L.done) return t(c, N), U && In(c, P), x;
            if (N === null) {
            ...
            for (N = r(c, N); !L.done; P++, L = f.next())
                (L = g(N, c, P, L.value, y)),
                    L !== null &&
                        (e &&
                            L.alternate !== null &&
                            N.delete(L.key === null ? P : L.key),
                        (a = i(L, a, P)),
                        _ === null ? (x = L) : (_.sibling = L),
                        (_ = L));
            return (
                e &&
                    N.forEach(function (vf) {
                        return n(c, vf);
                    }),
                U && In(c, P),
                x
                ...
                switch (f.$$typeof) {
                    case on:
                        e: {
                            ...
                            f.type === Le
                                ? ((a = Wn(f.props.children, c.mode, y, f.key)),
                                  (a.return = c),
                                  (c = a))
                                : ((y = vl(
                                      f.type,
    ...
    function Ri(e, n, t, r, l, i) {
        if (
            ...
            (n.updateQueue = null),
            (n.lanes = 0),
            (Jr.current = e === null || e.memoizedState === null ? Bc : Hc),
            (e = t(r, l)),
            tr)
        ) {
            i = 0;
    ...
    function Oi(e) {
        ...
        if (((e = t.interleaved), e !== null)) {
            l = e;
            do (i = l.lane), (A.lanes |= i), (An |= i), (l = l.next);
            while (l !== e);
    ...
    function ns(e, n) {
        ...
        if (
            ...
            (r = r.queue),
            Ii(ls.bind(null, t, r, e), [e]),
            r.getSnapshot !== n || i || (J !== null && J.memoizedState.tag & 1))
        ) {
            if (
                ((t.flags |= 2048),
                ir(9, rs.bind(null, t, r, l, n), void 0, null),
                q === null)
            )
                throw Error(p(349));
            Vn & 30 || ts(t, n, l);
    ...
    function rs(e, n, t, r) {
        (n.value = t), (n.getSnapshot = r), is(n) && us(e);
    }
    function ls(e, n, t) {
        return t(function () {
            is(n) && us(e);
    ...
    function hs(e, n, t) {
        return Vn & 21
            ? (Oe(t, n) ||
                  ((t = $u()), (A.lanes |= t), (An |= t), (e.baseState = !0)),
              n)
            ...
            if (
                ...
                try {
                    var u = n.lastRenderedState,
                        o = i(u, t);
                    if (
                        ((l.hasEagerState = !0), (l.eagerState = o), Oe(o, u))
                    ) {
                        var s = n.interleaved;
                        s === null
                            ? ((l.next = l), xi(n))
        ...
        Bc = {
            ...
            useTransition: function () {
                var e = os(!1),
                    n = e[0];
                return (
                    (e = Uc.bind(null, e[1])), ($e().memoizedState = e), [n, e]
                );
            },
            ...
            useSyncExternalStore: function (e, n, t) {
                ...
                return (
                    (l.queue = i),
                    as(ls.bind(null, r, i, e), [e]),
                    (r.flags |= 2048),
                    ir(9, rs.bind(null, r, i, t, n), void 0, null),
                    t
                );
            },
            useId: function () {
    ...
    function Es(e, n, t) {
        ...
        return (
            typeof i == 'object' && i !== null
                ? (i = xe(i))
                : ((l = fe(n) ? On : te.current),
                  (r = n.contextTypes),
                  (i = (r = r != null) ? ct(e, l) : gn)),
            (n = new n(t, i)),
            (e.memoizedState =
    ...
    function Vi(e, n, t, r) {
        ...
        typeof i == 'object' && i !== null
            ? (l.context = xe(i))
            : ((i = fe(n) ? On : te.current), (l.context = ct(e, i))),
            (l.state = e.memoizedState),
            (i = n.getDerivedStateFromProps),
            typeof i == 'function' &&
                (Ui(e, n, i, t), (l.state = e.memoizedState)),
...
` +
        ...
        return (
            ...
            e !== null && !de
                ? ((n.updateQueue = e.updateQueue),
                  ...
                  (e.lanes &= ~l),
                  ln(e, n, l))
                : (U && t && vi(n), (n.flags |= 1), oe(e, n, r, l), n.child)
        );
    }
    function Ls(e, n, t, r, l) {
        if (e === null) {
            ...
            return typeof i == 'function' &&
                ...
                ? ((n.tag = 15), (n.type = i), Ms(e, n, i, r, l))
        ...
        return (
            ...
            e !== null && !de
                ? ((n.updateQueue = e.updateQueue),
                  ...
                  (e.lanes &= ~l),
                  ln(e, n, l))
                : (U && r && vi(n), (n.flags |= 1), oe(e, n, t, l), n.child)
        );
    }
    function Os(e, n, t, r, l) {
        ...
        if ((ht(n, l), n.stateNode === null))
            ll(e, n), Es(n, t, r), Vi(n, t, r, l), (r = !0);
        else if (e === null) {
            var u = n.stateNode,
                o = n.memoizedProps;
            u.props = o;
            ...
            (u.state = m),
                Gr(n, r, u, l),
                (s = n.memoizedState),
                o !== r || m !== s || ce.current || kn
                    ? (typeof v == 'function' &&
                          (Ui(n, t, v, r), (s = n.memoizedState)),
            ...
            o !== h || m !== S || ce.current || kn
                ? (typeof g == 'function' &&
                      (Ui(n, t, g, r), (S = n.memoizedState)),
    ...
    function Qi(e, n, t, r, l, i) {
        Ds(e, n);
        var u = (n.flags & 128) !== 0;
        if (!r && !u) return l && Vo(n, t, !1), ln(e, n, i);
        ...
        return (
            (n.flags |= 1),
            e !== null && u
                ? ((n.child = mt(n, e.child, null, i)),
                  (n.child = mt(n, null, o, i)))
                : oe(e, n, o, i),
    ...
    function Kc(e, n, t, r, l, i, u) {
        if (t)
            return n.flags & 256
                ? ((n.flags &= -257), (r = Ai(Error(p(422)))), rl(e, n, u, r))
                : n.memoizedState !== null
                  ...
                  : ((i = r.fallback),
                    ...
                    (r.sibling = i),
                    (n.child = r),
                    n.mode & 1 && mt(n, e.child, null, u),
                    (n.child.memoizedState = $i(u)),
                    (n.memoizedState = Wi),
                    i);
        ...
        if (((o = (u & e.childLanes) !== 0), de || o)) {
            if (((r = q), r !== null)) {
                ...
                (l = l & (r.suspendedLanes | u) ? 0 : l),
                    l !== 0 &&
                        l !== i.retryLane &&
                        ((i.retryLane = l), tn(e, l), Ve(r, e, l, -1));
            }
                ...
                if (((t = n.type), e !== null && n.stateNode != null))
                    ...
                    if (((e = Un(We.current)), Wr(n))) {
                        ...
                        (u = l.nodeType === 9 ? l : l.ownerDocument),
                            e === 'http://www.w3.org/1999/xhtml' && (e = zu(t)),
            ...
            case 13:
                if (
                    ...
                    if (U && we !== null && n.mode & 1 && !(n.flags & 128))
                        $o(), pt(), (n.flags |= 98560), (i = !1);
                    else if (
                        ((i = Wr(n)), r !== null && r.dehydrated !== null)
                    ) {
                        if (e === null) {
    ...
    function Jc(e, n) {
        ...
        for (
            si = { focusedElem: e, selectionRange: t }, _r = !1, k = n;
            k !== null;
                            ...
                            (u = k),
                                ...
                                u.tag === 22 && u.memoizedState !== null
                                    ...
                                    : s !== null
                                      ? ((s.return = u), (k = s))
                                      : bs(l);
                    for (; i !== null; ) (k = i), Zs(i), (i = i.sibling);
                    (k = l), (il = o), (ie = d);
                }
                Js(e);
            } else
    ...
    function me(e, n) {
        ...
        if (r === 0)
            ...
            if ((t != null && Hu(t), n === 1))
                e.tag === 0 ? Fc(na.bind(null, e)) : Ao(na.bind(null, e)),
                    Mc(function () {
                        !(T & 6) && wn();
                    }),
                    (t = null);
    ...
    function Hn(e, n) {
        ...
        if ((t !== -1 && ((e.timeoutHandle = -1), Lc(t)), K !== null))
    ...
    function Qn(e, n, t) {
        var r = R,
            l = Ne.transition;
        try {
            (Ne.transition = null), (R = 1), rf(e, n, t, r);
        } finally {
            (Ne.transition = l), (R = r);
        }
        return null;
    ...
    function Et() {
        if (xn !== null) {
            ...
            try {
                if (
                    ((Ne.transition = null), (R = 16 > e ? 16 : e), xn === null)
                )
                    var r = !1;
                else {
    ...
    sa = function (e, n, t) {
        if (e !== null)
            if (e.memoizedProps !== n.pendingProps || ce.current) de = !0;
            else {
                if (!(e.lanes & t) && !(n.flags & 128))
                    return (de = !1), Yc(e, n, t);
                de = !!(e.flags & 131072);
            }
    ...
    (wl.prototype.render = mu.prototype.render =
        function (e) {
            var n = this._internalRoot;
            if (n === null) throw Error(p(409));
            yl(e, n, null, null);
        }),
        (wl.prototype.unmount = mu.prototype.unmount =
            function () {
    ...
    wl.prototype.unstable_scheduleHydration = function (e) {
        if (e) {
            ...
            for (
                var t = 0;
                t < pn.length && n !== 0 && n < pn[t].priority;
                t++
            );
            pn.splice(t, 0, e), t === 0 && qu(e);
        }
    };
    function vu(e) {
        return !(
    ...
    (Yu = function (e) {
        ...
        (Ou = uu),
        (Fu = Bn);
    var pf = { usingClientEntryPoint: !1, Events: [Jt, st, Ur, Ru, Du, uu] },
        fr = {
        ...
        mf = {
            ...
            findFiberByHostInstance: fr.findFiberByHostInstance,
    ...
    return (
        ...
        (ve.findDOMNode = function (e) {
            ...
            return (e = Vu(n)), (e = e === null ? null : e.stateNode), e;
        }),
...
function Sf() {
    ...
    return M(), (hu.exports = wf()), hu.exports;
}
export { Sf as r };
